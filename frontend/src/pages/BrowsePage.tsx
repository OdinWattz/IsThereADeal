...
import { Search, Tag, Award, Star, Eye, Filter, X, Heart } from 'lucide-react'
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`wishlist-heart-btn absolute top-2 right-2 z-10 rounded-full p-2 ${wishlistByAppid.has(game.steam_appid) ? 'opacity-100 is-active' : 'opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:focus:opacity-100'} ${pendingWishlistAppids.has(game.steam_appid) ? 'cursor-not-allowed is-busy' : ''}`}
                  style={{
